#!/bin/bash
cd ~/IKD-mmt
Ckpt_dir=../checkpoints/multi30k/en-de/inverseKD_res_m_l2
...
--max-tokens 1024 --save-dir $Ckpt_dir --log-format json --max-update 70000 --find-unused-parameters --no-double-encoder --patience 10