#!/bin/bash
cd ~/IKD-mmt
Ckpt_dir=../checkpoints/multi30k/en-de/inverseKD_res_m_cos
Data_save=../data/multi30k/en-de/inverseKD

#CUDA_VISIBLE_DEVICES=2 
python train.py $Data_save \
...
--pretrained-cnn resnet50 --loss1-coeff 1. --loss2-coeff 1. --dist-func consine --grain model \
