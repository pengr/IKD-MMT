#!/bin/bash
cd ~/IKD-mmt
Ckpt_dir=../checkpoints/multi30k/en-de/inverseKD_res_m_l2_kd2
...
--pretrained-cnn resnet50 --loss1-coeff 1. --loss2-coeff 1. --dist-func l2 --grain gan \
--max-tokens 1024 --save-dir $Ckpt_dir --log-format json --max-update 40000 --find-unused-parameters --no-double-encoder \
>> /home/pengru/IKD-mmt/experiments/en-de/inverseKD/out/cl_train_res_m_l2_kd2.out