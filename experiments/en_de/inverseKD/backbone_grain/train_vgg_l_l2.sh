#!/bin/bash
cd ~/IKD-mmt
Ckpt_dir=../checkpoints/multi30k/en-de/inverseKD_vgg_l_l2
...
--pretrained-cnn vgg19 --loss1-coeff 1. --loss2-coeff 1. --dist-func l2 --grain layer --update-freq 2 \
--max-tokens 512 --save-dir $Ckpt_dir --log-format json --max-update 40000 --find-unused-parameters --no-double-encoder \
>> /home/pengru/inverseKD-mmt/experiments/en-de/inverseKD/out/cl_train_vgg_l_l2.out