#!/bin/bash
cd ~/IKD-mmt
Ckpt_dir=../checkpoints/multi30k/en-de/inverseKD_res_m_l2_seed100
...
--max-tokens 1024 --save-dir $Ckpt_dir --log-format json --max-update 50000 --seed 100 --find-unused-parameters --no-double-encoder