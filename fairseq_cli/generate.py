...
def _main(args, output_file):
    ...
    # <fix>
    if os.path.exists(args.results_path+'/SynLocal_v.pickle'):
         os.rename(args.results_path+'/SynLocal_v.pickle', args.results_path+f'/{args.gen_subset}SynLocal_v.pickle')
    if os.path.exists(args.results_path+'/OrgLocal_v.pickle'):
         os.rename(args.results_path+'/OrgLocal_v.pickle', args.results_path+f'/{args.gen_subset}OrgLocal_v.pickle')
