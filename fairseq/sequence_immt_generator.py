...
class SequenceImmtGenerator(object):
    def __init__(
        self,
        tgt_dict,
        beam_size=1,
    ...
    def _generate(
        ...
        **kwargs
        ...
        # <fix>, divide into train mode or eval mode
        if isinstance(encoder_outs[0][0], tuple):
...
class SequenceGeneratorWithAlignment(SequenceImmtGenerator):
