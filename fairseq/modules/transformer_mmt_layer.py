...
from fairseq.modules import LayerNorm, MultiheadAttention, MultiheadMMTAttention  # <fix>
from torch import Tensor


class TransformerMMTEncoderLayer(nn.Module):  # <fix>
    """Encoder layer block.
    ...
    *args.encoder_normalize_before* to ``True``.
    ...
    def forward(self, x, x_txt, encoder_padding_mask, attn_mask: Optional[Tensor] = None):  # <fix>
        """
        Args:
...
class TransformerMMTDecoderLayer(nn.Module):
    """Decoder layer block.
    ...
    *args.decoder_normalize_before* to ``True``.
    ...
    def build_encoder_attention(self, embed_dim, args):  # <fix>
        return MultiheadMMTAttention(
            embed_dim,
            args.decoder_attention_heads,
