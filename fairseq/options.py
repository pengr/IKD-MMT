...
def add_preprocess_args(parser):  # actual preprocessing parameters
    ...
    group.add_argument("--images-path", metavar="FP", default=None,
                       help="Path to the directory containing the images")
    group.add_argument("--train-fnames", metavar="FP", default=None,
                       help="""File containing a list with training image file names.""")
    group.add_argument("--valid-fnames", metavar="FP", default=None,
                       help="""File containing a list with validation image file names.""")
    group.add_argument("--test-fnames", metavar="FP", default=None,
...
def add_distributed_training_args(parser):
    ...
    group.add_argument('--find-unused-parameters', default=False, action='store_true',
                       help='disable script parameter detection (not applicable to '
                       'no_c10d ddp-backend')
